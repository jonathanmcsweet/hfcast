 ...
 *
 * One module for both projects. It was two identical files held together
 * by a character-for-character comparison of their source text; what that
 * protected was the arithmetic below, not the constants, because the
 * engine snaps a rectangle to its own lattice and a server cutting on a
 * different one runs rows twice or drops them.
 */
