/**
 * The operator's mode, and the signal-to-noise it needs.
 *
 ...
 *
 * One table for both projects. It was three copies: two inside the app,
 * one on the server, with the server's test comparing them by regular
 * expression over the app's source.
 */
...
/** The mode every earlier version assumed without saying. */
