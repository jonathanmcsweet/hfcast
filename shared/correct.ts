 ...
 */
import type { BandHourPrediction, RawBandHour } from './bands.ts';

// Re-exported because every caller of `correctCells` has to name the shape
// it takes, and this is where they reach for it.
